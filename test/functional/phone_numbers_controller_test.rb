...
class PhoneNumbersControllerTest < ActionController::TestCase
  ...
  test "should create phone_number" do
    assert_difference('PhoneNumber.count') do
      post :create, phone_number: { contact_id: @phone_number.contact_id, phone: @phone_number.phone, type: @phone_number.type }
    end
  ...
  test "should update phone_number" do
    put :update, id: @phone_number, phone_number: { contact_id: @phone_number.contact_id, phone: @phone_number.phone, type: @phone_number.type }
    assert_redirected_to phone_number_path(assigns(:phone_number))
  end
